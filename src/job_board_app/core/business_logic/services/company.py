...
def create_company(  # pylint: disable=too-many-locals
    ...
    with transaction.atomic():
        business_areas: list[str] = re.split("[ \r\n]+", company_data.business_area)
        ...
        for area in business_areas:
            ...
            try:
                ...
                logger.warning("Business area doesn't exist.", extra={'Business_area': area})
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    msg="Country with entered name does not exist.",
                    extra={"country_name": address_data.country},
                )
        ...
        try:
            ...
            logger.info(
                msg="Company with entered name already exist.",
                extra={"company_name": company_data.name},
            )
...
def get_company_profile_by_id(company_id: int) -> CompanyProfile:
    ...
    try:
        ...
        raise CompanyProfileNotExistsError
    return profile
